...
public class GA {
    ...
    protected ArrayList<TSP.Tour> population;
    protected ArrayList<TSP.Tour> offspring;
    ...
    protected void swapMutation(TSP.Tour off) {
    ...
    protected TSP.Tour[] pmx(TSP.Tour parent1, TSP.Tour parent2, TSP problem) {
    ...
    protected boolean contains(TSP.City[] path, TSP.City city, int start, int end) {
    ...
    protected int findIndex(TSP.City[] path, TSP.City city) {
    ...
    protected TSP.Tour tournamentSelection() {
