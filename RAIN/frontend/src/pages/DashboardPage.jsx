      ...
      <div className="min-h-screen bg-base-200 p-4">
        <div className="navbar bg-base-100 rounded-box shadow-lg mb-6">
          <div className="flex-1">
            <Link to="/" className="btn btn-ghost normal-case text-xl">Pametni Paketnik</Link>
          </div>
        ...
        <div className="hero bg-base-100 rounded-box shadow-lg mb-6">
          <div className="hero-content text-center">
            <div>
              ...
              <p className="py-4">Uspešno ste prijavljeni v sistem Pametni Paketnik.</p>
            </div>
          </div>
        </div>
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              ...
              <div className="card-actions justify-end mt-4">
                <button className="btn btn-primary" onClick={() => setIsModalOpen(true)}><FaPlusCircle className="mr-2" /> Dodaj paketnik</button>
              </div>
            </div>
          </div>
        </div>
        ...
        {isModalOpen && (
            <div className="modal modal-open">
              <div className="modal-box">
                ...
                <h3 className="font-bold text-lg">Dodaj nov paketnik</h3>
                <p className="py-4">Vnesite ID paketnika (preberete ga na paketniku) in mu določite ime po meri.</p>
                ...
                <form onSubmit={handleAddBox}>
                  ...
                  <div className="form-control mt-4">
                    ...
                    <input type="text" placeholder="npr. Domači paketnik" className="input input-bordered" value={newBoxName} onChange={(e) => setNewBoxName(e.target.value)} />
                  </div>
